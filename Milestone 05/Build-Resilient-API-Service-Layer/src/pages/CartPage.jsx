...
export default function CartPage() {
  ...
  useEffect(() => {
    async function fetchCartData() {
      try {
        setLoading(true)
        // Step 10: Replaced fetch block with getCart() service method
        ...
        // Secondary data detail extraction preserved with standard fetch requests
  ...
  const handleRemove = async (productId) => {
    ...
    // Step 10: Removed localStorage token retrieval and replaced fetch with removeCart(id)
    try {
